...
const strategistSchema = {
    ...
    properties: {
        ...
        validationScore: {
            type: "integer",
            description: "0-100 score indicating how validated the startup concept is."
        },
        riskScore: {
            type: "integer",
            description: "0-100 score indicating the risk level of the startup concept."
        },
        founderMarketFit: {
            type: "integer",
            description: "0-100 score indicating how well the founder fits the market they are targeting."
        }
    },
    required: ["thesis", "positioning", "recommendations", "validationScore", "riskScore", "founderMarketFit"]
};
...
const executionCoachSchema = {
    ...
    properties: {
        ...
        executionReadiness: {
            type: "integer",
            description: "0-100 score indicating how ready the startup is for execution."
        },
        fundraisingReadiness: {
            type: "integer",
            description: "0-100 score indicating how ready the startup is for fundraising."
        },
        nextBestActions: {
            type: "array",
            items: { type: "string" },
            description: "Top 3 next best actions the founder should take immediately."
        }
    },
    required: ["sevenDaySprint", "thirtyDayRoadmap", "validationChecklist", "nextAssets", "executionReadiness", "fundraisingReadiness", "nextBestActions"]
};
