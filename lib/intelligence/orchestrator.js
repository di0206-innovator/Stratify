...
class GeminiBIOrchestrator {
    ...
    async processInquiry(userQuery, options = {}) {
        ...
        let executionPlan = this.mode === 'live'
        ...
        if (criticResult.verdict === 'revise' && this.mode === 'live') {
        ...
        const finalResult = {
            ...
            agentLogs,
            mode: this.mode,
            intelligenceMode: (this.mode === 'live' && this.searchProvider.enabled) ? 'live_web' : 'demo_grounding',
