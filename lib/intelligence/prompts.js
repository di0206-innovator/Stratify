...
const TRENDS_STRUCTURED_PROMPT = `You are NeuralBI's Market Trends Analyst Agent. Analyze the research data below and extract structured signals and opportunity gaps for a startup founder.
...
const RISKS_STRUCTURED_PROMPT = `You are NeuralBI's Risk & Defense Assessment Specialist. Analyze the research data below and identify structural risks and critical assumptions for a startup founder.
...
const CRITIC_STRUCTURED_PROMPT = `You are NeuralBI's Quality Assurance & Research Critic. Audit the draft startup report sections below.
...
const REACT_STEP_PROMPT = `You are NeuralBI's ReAct Researcher Agent. Decide on the next research step based on the founder context and the history of previous turns.
