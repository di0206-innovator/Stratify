...
export default function PitchBrief({ mode = 'builder', founderProfile }) {
  ...
  if (error && error.type === 'UNAUTHORIZED') {
    return (
      <div className="max-w-2xl mx-auto px-4 py-16 relative z-10">
        <div className="neo-card bg-white border-[4px] border-black p-8 text-center shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] select-none">
          <div className="inline-flex p-4 bg-[#EF4444] border-[3px] border-black text-white mb-6">
            <Lock size={40} />
          </div>
          <h1 className="text-2xl sm:text-4xl font-black uppercase tracking-tight mb-2 text-black">
            Restricted Data Room
          </h1>
          <div className="inline-block bg-[#EF4444] text-white px-2.5 py-0.5 text-[9px] font-black uppercase tracking-wider mb-4 border border-black">
          ...
          <div className="flex gap-4 justify-center">
            <Link to="/" className="px-4 py-2 border-[3px] border-black font-black text-xs uppercase bg-white text-black shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-none active:translate-x-[2px] active:translate-y-[2px] transition-all">
              Return Home
            </Link>
          </div>
        </div>
  ...
  if (error) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-16 relative z-10">
        <div className="neo-card bg-white border-[4px] border-black p-8 text-center shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] select-none">
          <div className="inline-flex p-4 bg-[#FCD34D] border-[3px] border-black text-black mb-6">
            <ShieldAlert size={40} />
          </div>
          <h1 className="text-2xl sm:text-4xl font-black uppercase tracking-tight mb-2 text-black">
            Vault Error
          ...
          <Link to="/" className="px-4 py-2 bg-[#EF4444] text-white border-[3px] border-black font-black text-xs uppercase shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-none active:translate-x-[2px] active:translate-y-[2px] transition-all">
            Return Home
          </Link>
        </div>
      </div>
  ...
  if (mode === 'public') {
    return (
      <div className="max-w-4xl mx-auto px-4 py-8 relative z-10 space-y-6">
        ...
        <div className="neo-card bg-white text-black p-8 border-[4px] border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] select-none relative overflow-hidden flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          ...
          <div className="relative z-10 space-y-2">
            <div className="flex gap-2">
              <span className="inline-block bg-[#3B82F6] text-white px-2.5 py-0.5 text-[9px] font-black uppercase tracking-wider border border-black">
          ...
          {deckUrl && (
            <a
              ...
              className="relative z-10 inline-flex items-center gap-2 px-4 py-2.5 bg-[#FCD34D] text-black border-[3px] border-black font-black text-xs uppercase shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none hover:-translate-x-[1px] hover:-translate-y-[1px] hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all cursor-pointer"
            >
        ...
        <div className="grid grid-cols-12 gap-6">
          <div className="col-span-12 md:col-span-6">
            <BentoCard title="The Problem Statement" badge="PAIN POINT AUDIT" badgeColor="bg-[#EF4444]">
          ...
          <div className="col-span-12 md:col-span-6">
            <BentoCard title="The Solution Wedge" badge="PRODUCT DEFENSE" badgeColor="bg-[#3B82F6]">
              <div className="border-2 border-black p-5 bg-[#F8F7F4] flex-1">
                <p className="font-outfit font-semibold text-gray-700 text-sm leading-relaxed whitespace-pre-wrap">
          ...
          {showRunway && (
            <div className="col-span-12">
              <BentoCard title="Strategic Runway Posture" badge="VERIFIED LIVE GRAPH" badgeColor="bg-[#A3E635]">
                <div className="border-2 border-black p-6 bg-white flex flex-col sm:flex-row justify-between items-center gap-4">
                  ...
                  <Link to="/runway" className="px-4 py-2 border-[3px] border-black font-black text-xs uppercase bg-[#A3E635] text-black shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-[1px] hover:-translate-y-[1px] hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all">
                    Open Runway Planner
                  </Link>
                </div>
              </BentoCard>
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 relative z-10 space-y-6">
      {/* Title */}
      <div className="neo-card bg-white text-black p-8 border-[4px] border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] select-none relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="absolute -top-10 -right-10 w-32 h-32 bg-[#3B82F6] border-[4px] border-black rounded-full opacity-80 pointer-events-none hidden md:block"></div>
        <div>
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-12 lg:col-span-7">
          <BentoCard title="Compile Pitch Brief" badge="DATA ROOM SETTINGS" badgeColor="bg-[#FCD34D]">
            <form onSubmit={handleSave} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={saving}
                className="w-full py-3 bg-[#EF4444] text-white border-[3px] border-black font-black text-xs uppercase shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none hover:-translate-x-[1px] hover:-translate-y-[1px] hover:shadow-[5px_5px_0px_0px_rgba(0,0,0,1)] transition-all flex items-center justify-center gap-2 cursor-pointer"
              >
        ...
        <div className="col-span-12 lg:col-span-5">
          <BentoCard title="Access Hub" badge="DISTRIBUTION CENTER" badgeColor="bg-[#3B82F6]">
            {briefId ? (
              <div className="space-y-4 h-full flex flex-col justify-between">
                <div className="space-y-4">
                  <div className="border-2 border-black p-4 bg-gray-50 text-left">
                    ...
                    <div className="flex items-center gap-2">
                      <span className={`w-3 h-3 rounded-full ${isPublic ? 'bg-[#A3E635]' : 'bg-[#EF4444]'} border-2 border-black`} />
                ...
                <div className="border-[3px] border-black p-4 bg-white flex flex-col items-center justify-center text-center py-8">
                  ...
                  <Link
                    to={`/brief/${briefId}`}
                    className="px-4 py-2 bg-[#A3E635] text-black border-[3px] border-black font-black text-xs uppercase shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-none active:translate-x-[2px] active:translate-y-[2px] transition-all"
                  >
                    Launch Data Room
                  </Link>
                </div>
