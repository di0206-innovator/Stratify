...
export default function Signals({ founderProfile }) {
  ...
  const getSentimentStyles = (sentiment) => {
    switch (sentiment?.toUpperCase()) {
      case 'POSITIVE':
        return 'bg-[#A3E635] text-black border-[#A3E635]';
      case 'NEGATIVE':
    ...
    <div className="max-w-6xl mx-auto px-4 py-8 space-y-6">
      ...
      {!founderProfile ? (
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 neo-card bg-[#F8F7F4] flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 p-4 select-none">
            {/* Search Input */}
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="neo-input py-1.5 px-3 text-xs w-36"
                >
            ...
            {loading && signals.length === 0 ? (
              ...
              <div className="space-y-4">
                {filteredSignals.map((sig, index) => (
                  <div
                    key={index}
                    className="neo-card bg-white flex flex-col md:flex-row md:items-start gap-4 border-[3px] border-black p-5 relative group"
                  >
                    {/* Hard outline Indicator bar */}
                    <div className="md:w-36 shrink-0 space-y-2 select-none">
                      {/* Signal Type */}
                      <span className="neo-badge text-[9px] font-black border-2 border-black w-full text-center tracking-wider block overflow-hidden truncate">
                        {sig.type || 'SIGNAL'}
                      </span>
