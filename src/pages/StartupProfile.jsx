...
export default function StartupProfile() {
 ...
 <Link to="/" className="os-btn-primary py-2 px-6 text-xs uppercase">
 <ArrowLeft size={14} />
 ...
 {/* Hero Banner */}
 <div className="os-card bg-black text-[#A3E635] p-8 sm:p-12 mb-8 relative overflow-hidden select-none">
 ...
 <div className="w-16 h-16 bg-emerald-500 text-black border-2 border-black flex items-center justify-center font-black text-2xl uppercase">
 {startup.name ? startup.name.slice(0, 2) : 'ST'}
 </div>
 <div>
 <span className="inline-flex items-center gap-1 bg-emerald-500 text-black px-2 py-0.5 border border-black font-outfit font-black text-[9px] uppercase tracking-wider mb-2">
 {startup.stage} Stage
 </span>
 ...
 {/* Startup Score Badge */}
 <div className="bg-emerald-500 text-black border-2 border-black px-5 py-3 font-outfit font-black text-center transform rotate-1">
 ...
 <div className=" p-4 bg-gray-50 h-[300px] flex flex-col justify-center">
 {hoveredNode ? (
 <>
 ...
 <div className="absolute -left-[35px] top-0 w-6 h-6 bg-white flex items-center justify-center font-black rounded-none">
 ...
 <span className={`text-[9px] font-black uppercase px-2 py-0.5 border border-black ${decision.status === 'completed' ? 'bg-emerald-500' : decision.status === 'invalidated' ? 'bg-red-400 text-white' : 'bg-yellow-300'}`}>
 {decision.status}
 </span>
 </div>
 ...
 <span className="font-bold text-black uppercase bg-emerald-500 px-2 py-0.5 border border-black text-[10px]">
 {startup.stage}
 </span>
 </div>
 <div className="flex justify-between items-center py-2 border-b border-gray-100">
 ...
 <div className="os-card bg-[#F8F7F4] p-6 select-none text-center">
 ...
 <span className={`text-[8px] font-black uppercase px-1 py-0.5 mt-1 inline-block border border-black ${signal.sentiment === 'positive' ? 'bg-emerald-500' : signal.sentiment === 'negative' ? 'bg-red-400 text-white' : 'bg-yellow-300'}`}>
 {signal.sentiment}
 </span>
 </div>
))}
