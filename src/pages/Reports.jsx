...
export default function Reports({ user, setUser, openAuthModal, founderProfile }) {
 ...
 {/* Header */}
 <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 select-none">
 ...
 className="os-btn px-4 py-1.5 text-xs font-black cursor-pointer"
 >
 Sign Out
 </button>
 </div>
 ...
 <div className="w-8 h-8 border-t-transparent rounded-full animate-spin mx-auto text-black"></div>
 ...
 <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium text-[8px] px-1.5 py-0.5 border bg-emerald-500 text-black">
 ...
 className="p-1.5 bg-[#F472B6] border-2 border-black hover:bg-white text-black hover:-translate-x-[0.5px] hover:-translate-y-[0.5px] hover: active:translate-x-[1px] active:translate-y-[1px] active:shadow-none transition-all cursor-pointer shrink-0"
 >
 <Trash2 size={12} />
 </button>
 </div>
 ...
 type="button"
 onClick={copyLink}
 className="os-btn-primary px-4 py-2 text-xs font-black uppercase flex items-center gap-1.5"
 >
 ...
 <label className={`flex-1 p-3.5 flex items-center justify-between cursor-pointer transition-all ${isPublic ? 'bg-emerald-500 ' : 'bg-white'}`}>
 ...
 <label className={`flex-1 p-3.5 flex items-center justify-between cursor-pointer transition-all ${!isPublic ? 'bg-red-500 text-white ' : 'bg-white text-black'}`}>
 <span className="font-outfit font-black text-xs uppercase flex items-center gap-1.5">
 ...
 className="os-btn-primary px-8 py-3 text-xs font-black uppercase flex items-center gap-2"
 >
