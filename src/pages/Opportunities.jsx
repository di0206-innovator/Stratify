...
const TYPE_CONFIG = {
  ...
  grant: { icon: Gift, color: 'bg-[#A3E635]', label: 'Grant' },
  program: { icon: Building2, color: 'bg-[#C084FC]', label: 'Program' },
...
export default function Opportunities({ founderProfile }) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 space-y-6">
      ...
      <div className="bg-white border-[3px] border-black p-6 shadow-neo-hard select-none">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <span className="bg-[#A3E635] border-[3px] border-black px-3 py-1 font-black text-xs uppercase">
      ...
      {/* Search & Filters */}
      <div className="bg-white border-[3px] border-black p-4 shadow-neo-hard">
          ...
          <div className="flex gap-2 flex-wrap">
            {typeOptions.map(opt => (
              <button
                ...
                className={`px-3 py-2 border-[3px] border-black font-black text-xs uppercase transition-all ${
      ...
      {loading ? (
        ...
        <div className="bg-white border-[3px] border-black p-12 text-center">
          <div className="bg-[#FB923C] border-[3px] border-black p-4 inline-block mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {filteredOpportunities.map((opp, idx) => {
            ...
            return (
              <div
                key={opp.id || idx}
                className="bg-white border-[3px] border-black p-5 shadow-neo-hard hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] transition-all flex flex-col"
              >
