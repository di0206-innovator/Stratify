...
export default function BountyBoard({ founderProfile, user }) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      {/* Header Banner */}
      <div className="neo-card bg-black text-[#A3E635] p-8 sm:p-12 mb-8 border-[4px] border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] relative overflow-hidden select-none text-left">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          <BentoCard title="Active Sprint Bounties" badge="OPEN TASK POOL" badgeColor="bg-[#3B82F6]">
            {loading ? (
                  ...
                  <div key={bounty.id} className="border-3 border-black p-4 bg-white text-left space-y-3 hover:translate-y-[-1px] transition-transform">
                    <div className="flex justify-between items-start flex-wrap gap-2">
                      ...
                      <div className="flex gap-2">
                        ...
                        <span className="bg-[#C084FC] text-black border-2 border-black px-2 py-0.5 text-[9px] font-black uppercase tracking-wider">
                          +{bounty.points} Score
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="pt-3 border-t border-gray-100 flex justify-between items-center flex-wrap gap-2">
                      <span className={`text-[9px] font-black uppercase border px-2 py-0.5 ${
                        bounty.status === 'completed' ? 'bg-[#A3E635]/25 border-green-500 text-green-700' : 'bg-yellow-50 border-yellow-500 text-yellow-700'
                      }`}>
                        {bounty.status}
                      </span>
                      ...
                      {bounty.status === 'open' ? (
                        <button
                          ...
                          className="px-3 py-1 bg-black text-white border-2 border-black text-[10px] font-black uppercase hover:bg-gray-800 cursor-pointer shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-x-[1px] active:translate-y-[1px] active:shadow-none"
                        >
        ...
        <div className="space-y-6">
          ...
          {founderProfile && founderProfile.role === 'founder' && (
            <BentoCard title="Launch a Micro Bounty" badge="FOUNDER UTILITY" badgeColor="bg-[#EF4444]">
              <form onSubmit={handleCreateBounty} className="space-y-4">
                ...
                <button
                  type="submit"
                  disabled={posting}
                  className="w-full py-2.5 bg-[#EF4444] text-white border-2 border-black font-black text-xs uppercase shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-x-[1px] active:translate-y-[1px] active:shadow-none hover:-translate-x-[0.5px] hover:-translate-y-[0.5px] hover:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] transition-all cursor-pointer text-center"
                >
          ...
          {selectedBounty && (
            <BentoCard title="Claim & Submit Proof" badge="BUILDER VERIFICATION" badgeColor="bg-[#C084FC]">
              <form onSubmit={handleSubmitBounty} className="space-y-4">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 py-2.5 bg-[#A3E635] text-black border-2 border-black font-black text-xs uppercase shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-x-[1px] active:translate-y-[1px] active:shadow-none hover:-translate-x-[0.5px] hover:-translate-y-[0.5px] hover:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] transition-all cursor-pointer text-center"
                  >
          ...
          {/* Builder Guide Info */}
          <div className="neo-card bg-[#F8F7F4] border-[3px] border-black p-5 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] select-none text-center">
