...
export default function AdminDashboard() {
 ...
 {/* Title block */}
 <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-white p-6 -hard">
 ...
 disabled={loading}
 className="os-btn-primary flex items-center gap-2 px-4 py-2 self-stretch sm:self-auto justify-center cursor-pointer text-xs font-black uppercase"
 >
 ...
 {loading && !stats ? (
 <div className="os-card p-16 text-center bg-white space-y-4">
 <div className="w-12 h-12 border-t-transparent rounded-full animate-spin mx-auto text-black"></div>
 <span className="font-outfit font-black uppercase text-xs">Accessing System Core...</span>
 </div>
) : error ? (
 <div className="os-card p-6 bg-neo-pink font-bold text-black flex items-start gap-3">
 ...
 {/* Users card */}
 <div className="bg-white p-6 -hard flex items-center justify-between">
 <div>
 ...
 <div className="bg-emerald-500 border-2 border-black p-2.5">
 <Users size={22} />
 </div>
 </div>
 ...
 <div className="bg-purple-600 border-2 border-black p-2.5">
 <FileText size={22} />
 </div>
 </div>
 ...
 activeTab === 'users' ? 'bg-emerald-500 z-10' : 'bg-white hover:bg-gray-100'
 }`}
 >
 ...
 className={`px-5 py-3 text-xs sm:text-sm font-black uppercase border-t-[3px] border-x-[3px] border-black translate-y-[3px] -mr-[3px] transition-all cursor-pointer ${
 activeTab === 'reports' ? 'bg-purple-600 z-10' : 'bg-white hover:bg-gray-100'
 }`}
 >
 ...
 {/* Tab Content */}
 <div className="bg-white p-6 -hard min-h-[300px]">
 {activeTab === 'users' && (
 ...
 r.mode === 'live' ? 'bg-emerald-500' : 'bg-gray-200'
 }`}>
