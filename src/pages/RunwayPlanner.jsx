...
export default function RunwayPlanner({ user, openAuthModal }) {
 ...
 return { label: 'DEFAULT ALIVE', color: 'bg-emerald-500', icon: ShieldCheck };
 }
 if (runwayMonths < 6) {
 ...
 <div className={`inline-flex items-center gap-1.5 ${Badge.color} px-4 py-2 font-outfit font-black text-sm uppercase tracking-wider `}>
 <BadgeIcon size={16} />
 ...
 <BentoCard title="Financial Controls" badge="REAL-TIME SLIDERS" badgeColor="bg-purple-600" className="h-auto">
 ...
 <BentoCard title="AI Scenario Simulator" badge="NATURAL LANGUAGE" badgeColor="bg-red-500">
 ...
 className="w-full py-2.5 bg-red-500 text-white border-2 border-black font-black text-xs uppercase active:translate-x-[1px] active:translate-y-[1px] active:shadow-none hover:-translate-x-[0.5px] hover:-translate-y-[0.5px] hover: transition-all flex items-center justify-center gap-2 cursor-pointer"
 >
 ...
 className="w-full bg-emerald-500 text-black font-black py-2 active:translate-x-[1px] active:translate-y-[1px] active:shadow-none transition-all flex items-center justify-center gap-2 cursor-pointer uppercase text-xs mt-3 select-none"
 >
