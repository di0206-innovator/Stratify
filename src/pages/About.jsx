...
export default function About() {
  return (
    <div className="max-w-4xl mx-auto px-6 py-16 space-y-12 animate-fade-in text-[#111] select-text">
      {/* Back Button */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm text-gray-600 leading-relaxed font-inter">
      ...
      {/* Leadership Profile */}
      <div className="bg-[#FAF9F6] border border-gray-200 p-8 rounded-2xl space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 border-t border-gray-200 pt-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 font-semibold uppercase tracking-wider mt-0.5 select-none">Founder & CEO</p>
            </div>
          </div>
          ...
          <a 
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#C8E64A] text-black text-xs font-bold uppercase tracking-wider rounded-lg hover:bg-[#B5D235] transition-colors shadow-sm select-none"
          >
            <Linkedin size={14} />
