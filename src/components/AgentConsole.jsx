...
export default function AgentConsole({ logs, isRunning }) {
 ...
 {/* Console Header */}
 <div className="flex items-center justify-between bg-black border-b-[3px] border-black px-4 py-2 text-xs text-text-muted select-none">
 ...
 >
 {logs.length === 0 ? (
 <div className="text-text-secondary italic select-none">
 ...
 <span className="text-text-secondary shrink-0 select-none">[{formattedTime}]</span>
